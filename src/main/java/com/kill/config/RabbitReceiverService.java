...
public class RabbitReceiverService {
    ...
    public void consumeEmailMsg(KillSuccessUserInfo info){
        try {
            ...
            final String content=String.format(env.getProperty("mail.kiilsuccesscontent"),info.getItemName(),info.getCode());
            MailDto dto=new MailDto(env.getProperty("mail.killsuccesssubject"),content,new String[]{info.getEmail()});
        ...
        try {
            ...
            if (info!=null){
                ...
                if (entity!=null && entity.getStatus().intValue()==0){
                    int i = itemKillSuccessMapper.expireOrder(info.getCode());
